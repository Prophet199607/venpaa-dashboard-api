...
class CreateItemTransactionHeader extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_transaction_header', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('item_transaction_header');
    }
}
