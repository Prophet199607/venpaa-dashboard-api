...
class CreateItemReqTransHeadersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_req_trans_headers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('item_req_trans_headers');
    }
}
