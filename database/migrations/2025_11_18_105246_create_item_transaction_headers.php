...
class CreateItemTransactionHeaders extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_transaction_headers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('item_transaction_headers');
    }
}
