...
class CreateTempTransactionHeadersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_transaction_headers', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('ref_number')->default(0);
    ...
    {
        Schema::dropIfExists('temp_transaction_headers');
    }
}
